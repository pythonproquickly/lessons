...
class Testblackjack2(unittest.TestCase):
    ...
    def test_stand_on_soft_rubric(self):
        ...
        self.assertTrue(blackjack2.stand(16, STAND_ON_SOFT, [5, 8]))  # changed(False)
        self.assertTrue(blackjack2.stand(16, HIT_ON_SOFT, [5, 8]))  # changed(False)
        self.assertTrue(
            blackjack2.stand(16, STAND_ON_SOFT, [5, 7, 3])
        )  # changed(False)
        self.assertTrue(blackjack2.stand(16, HIT_ON_SOFT, [5, 7, 3]))  # changed(False)
