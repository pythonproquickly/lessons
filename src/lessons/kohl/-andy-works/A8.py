...
from src.lessons.kohl.A8.BarChartBuilder import barchart
...
# You use the third optional parameter to assign a new theme (see canvas
# writeup
...
# The GUI remains open until the user presses the exit button or quits the
# window
