...
# The function takes in five parameters: county1, county2, choice1, choice2,
# and dictionary
...
def barchart(county1='', county2='', choice1='', choice2='', dict={}):
    ...
    display_value1 = []
    display_value2 = []
    # note changes to next 4 lines --------------------------------------------
    display_value1.append(dict[county1[0]][choice1[0]])
    display_value1.append(dict[county2[0]][choice1[0]])
    display_value2.append(dict[county1[0]][choice2[0]])
    display_value2.append(dict[county2[0]][choice2[0]])
    ...
    plt.bar(pos_1, display_value1, color='#d8b365', width=bar_width,
            edgecolor='white', label=choice1)
    plt.bar(pos_2, display_value2, color='#5ab4ac', width=bar_width,
            edgecolor='white', label=choice2)
    ...
    plt.title(''.join(choice1[0]) + " x " + ''.join(choice2[0]) + ' by County')
