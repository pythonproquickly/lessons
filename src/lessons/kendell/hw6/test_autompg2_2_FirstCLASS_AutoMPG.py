...
class TestAutoMPG(unittest.TestCase):
    ...
    def test_eq_autompg_eq(self):
        autompg1 = autompgFINALDRAFT.AutoMPG(make = 'ford', model = 'toyota', year = '1975', mpg = '20.0')
        autompg2 = autompgFINALDRAFT.AutoMPG(make = 'ford', model = 'toyota', year = '1975', mpg = '20.0')
    ...
    def test_lt_autompg(self):
        autompg1 = autompgFINALDRAFT.AutoMPG(make = ' ', model = ' ', year = ' ', mpg = ' ')
        autompg2 = autompgFINALDRAFT.AutoMPG(make = 'ford', model = 'toyota', year = '1975', mpg = '20.0')
        self.assertTrue(autompg1 < autompg2)
...
if __name__ == '__main__':
    ...
    def test_eq_autompg(self):
        autompg1 = autompgFINALDRAFT.AutoMPG(make = 'ford', model = 'toyota', year = '1975', mpg = '20.0')
        #autompg2 = autompgFINALDRAFT.AutoMPG(make = 'chevrolet', model = 'camry', year = '1975', mpg = '20.0')
        self.assertFalse(autompg1, 42)
