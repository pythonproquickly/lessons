...
try:
    while True:
        ...
        seconds_top_row, seconds_middle_row, seconds_bottom_row = second_digits.splitlines()

        # Display the digits:
        print(
            hour_top_row + '      ' + minute_top_row + '      ' + seconds_top_row)
        print(
            hour_middle_row + '      ' + minute_middle_row + '      ' + seconds_middle_row)
        print(
            hour_bottom_row + '      ' + minute_bottom_row + '      ' + seconds_bottom_row)
