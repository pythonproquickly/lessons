...
def main():
    rooms = {
        'Room 1': {'East': 'Room 2', 'Item': 'Map', 'North': 'Wall',
                   'West': 'Wall', 'South': 'Wall'},
        'Room 2': {'North': 'Room 3', 'Item': 'Flashlight', 'East': 'Wall',
                   'West': 'Room 1', 'South': 'Wall'},
        'Room 3': {'West': 'Room 4', 'Item': 'Health Pack', 'South': 'Room 2',
                   'East': 'Wall', 'North': 'Wall'},
        'Room 4': {'West': 'Room 5', 'Item': 'Camouflage', 'East': 'Room 3',
                   'North': 'Wall', 'South': 'Wall'},
        'Room 5': {'West': 'Room 6', 'Item': 'Steel Ball', 'North': 'Wall',
                   'South': 'Wall', 'East': 'Room 4'},
        'Room 6': {'West': 'Room 7', 'Item': 'Baseball Bat', 'North': 'Wall',
                   'South': 'Wall', 'East': 'Room 5'},
        'Room 7': {'West': 'Room 8', 'Item': 'Picnic Basket', 'North': 'Wall',
                   'South': 'Wall', 'East': 'Room 6'},
    ...
    while True:
        ...
        if item == 'kidnapper':
            print(
                'Kidnapper noticed you, killed you and your sister, '
                'Game Over!')
            exit(0)
        while True:
