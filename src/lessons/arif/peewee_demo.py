#pip install peewee
# This program is a series of examples showing how peewee works.
# IT IS NOT A GOOD EXAMPLE OF HOW TO WRITE PEEWEE CODE
...
def set_pet_owners():
    ...
    herb_mittens_jr = Pet.create(owner=herb,
                                 name='Mittens Jr',
                                 animal_type='cat')
